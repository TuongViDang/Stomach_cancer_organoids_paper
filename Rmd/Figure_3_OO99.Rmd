...
---
title: "Stomach cancer paper Figure 3 OO99"
author: "Vi Dang"
date: "`r Sys.Date()`"
output:
  html_document:
...
cols <- c("cadetblue2", "dodgerblue4", "lightgreen", "mediumseagreen", "moccasin", "yellow2","lightsalmon4", "purple","lightseagreen","plum", "tomato", "aquamarine3") 
...
#In vivo 
    timepoints=c(0,1)      
    #create new column as in vivo only contain clone 3 and 4 (here 2 and 8)
    Clones_all_new$pseudo_in = c(0,58, 0,  0, 100, rep(0,7) ) 
    frac.table = as.matrix(Clones_all_new[,c(6,6)])

    #provide a vector listing each clone's parent (0 indicates no parent)
    parents = as.integer(parentIDs_new)
    #change the parent of 8 to 0 (index 5)
    parents[5] = 0
    #create a fish object
    fish = createFishObject(frac.table,parents,timepoints=timepoints)
